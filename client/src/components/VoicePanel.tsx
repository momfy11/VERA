...
export function VoicePanel({ sessionActive, onVadStart, onVadEnd, onStatusChange }: VoicePanelProps) {
  ...
  return (
    <section className="panel">
      ...
      <div className="panel-actions">
        <button type="button" className="button" onClick={start} disabled={!sessionActive || isRunning}>
          Start voice
        </button>
